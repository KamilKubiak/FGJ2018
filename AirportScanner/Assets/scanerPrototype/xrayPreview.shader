	...
	SubShader
	{
		...
		{ 
			...
			half4 frag ( v2f_img_custom i ) : SV_Target
			{
				...
				float temp_output_73_0 = length( ( uv69 - float2( 0.5,0.5 ) ) );
				float4 temp_output_82_0 = ( ( temp_output_73_0 * float4(0,1,0,1) * _MoouseCoords.z ) + ( temp_output_73_0 * float4(1,0,0,1) * _MoouseCoords.w ) );
				float4 lerpResult86 = lerp( lerpResult50 , temp_output_82_0 , temp_output_73_0);
...
/*ASEBEGIN
Version=15800
49;590;1746;1004;290.3163;955.5622;1.717618;True;False
...
Node;AmplifyShaderEditor.LengthOpNode;73;1092.897,-757.678;Float;False;1;0;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;1217.98,-934.9247;Float;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;78;1117.368,-1084.801;Float;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;82;1334.434,-1047.355;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;86;1735.629,-928.2609;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;85;1220.07,-605.3071;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=1F0AC33EA9DA9691727AD4063243504267A0A3EE